...
export const ecosystemProjects: EcosystemProject[] = [
  // Category 1: AI & Content Generation
  {
    ...
    status: "production",
    description:
      "Революционная мультиагентная система для автоматизации маркетинга с 5 специализированными AI-агентами",
    keyFeatures: [
  ...
  },
  {
    ...
    status: "production",
    description:
      "Революционная экосистема, где AI-экспертиза становится торгуемым цифровым активом",
    keyFeatures: [
  ...
  // Category 2: DeFi & Financial Infrastructure
  {
    ...
    progress: 65,
    description:
      "Платформа для институционального DeFi-кредитования, объединяющая B2B кредитование с P2P yield opportunities",
    keyFeatures: [
  ...
  },
  {
    ...
    status: "production",
    description:
      "Комплексная DeFi-экосистема на Binance Smart Chain с двумя токенами и системой стейкинга",
    keyFeatures: [
  ...
  },
  {
    ...
    status: "production",
    description:
      "Высокопроизводительная микросервисная система для безопасного управления криптовалютными кошельками",
    keyFeatures: [
